...
function connectorLabel(value:string):string{const normalized=value.toLowerCase();if(normalized.startsWith("xero"))return"Xero";if(normalized.startsWith("deputy"))return"Deputy";if(normalized.startsWith("lightspeed"))return"Lightspeed";return value;}
