  ...
  await page.route(/\/api\/recommended-analysis(?:\?.*)?$/u, async (route) => {
    ...
    const recommendations = options.recentAnalyses
      ? [
          {
            id: "rec-1-wednesday",
            title: "Analyse why bike sales fell 11% this week",
            question: "Which products explain the lower sales over the last seven days?",
          ...
          {
            id: "rec-2-parts",
            title: "Analyse why parts margin fell to 31%",
          ...
          {
            id: "rec-3-cash",
            title: "Review $6,400 in overdue customer payments",
            question: "Which customer payments changed over the last seven days and need following up?",
            why: "Overdue customer payments total $6,400 as of this week.",
            move: "close_the_loop",
            domain: "cash",
            tool: "xero",
    ...
    await route.fulfill({
      json: {
        ...
        windowStart: new Date(briefNow - 604_800_000).toISOString(),
        windowEnd: new Date(briefNow).toISOString(),
        expiresAt: new Date(briefNow + 93_600_000).toISOString(),
        timezone: "Australia/Melbourne",
