  ...
  "config": {
    ...
    "accessible_views": [
      ...
      },
      {
        ...
        "guidance": "Workforce (Deputy) grain. Authoritative hours worked and wage cost from timesheets, rostered / scheduled shifts and planned cost, open and published shifts, leave requests by type and status, staff headcount and positions. Labour against sales by day or week (labour cost as a share of sales, sales per labour hour) is one query here through the labour_sales_* members; rostered-versus-actual, late and no-show questions are one query through the shift_* members. Per-person cross-tool comparisons require an explicit governed identity mapping. Names alone do not establish identity. Without that mapping, keep the per-source figures separate and disclose the gap; use common periods for cross-source aggregate comparisons.\n"
      },
      {
