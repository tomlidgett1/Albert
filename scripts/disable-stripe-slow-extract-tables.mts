/**
 * Pause the live Stripe connector, disable extract-heavy tables that hang
 * the historical job, then start exactly one sync. Does not print secrets.
 *
 * Run: node --env-file=.env.local --import tsx scripts/disable-stripe-slow-extract-tables.mts
 */
