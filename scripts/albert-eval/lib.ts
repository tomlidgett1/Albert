...
export const SOURCE_FINDINGS = Object.freeze([
  ...
  { concept: "xero accounting coverage", finding: "Xero accounting is populated across the available history. The governed monthly accrual P&L is Xero's standard report landed through Fivetran; its Net Profit includes posted wages, super and every other P&L expense exactly once. Invoices, bills, bank activity and credit notes remain separate operational views.", recordedAt: "2026-08-18T12:00:00Z" },
  { concept: "xero payroll coverage", finding: "No Xero payroll-detail employees or pay runs were returned. This limits per-employee payslip analysis, but does NOT make wage expense unavailable: Wages and Salaries and Superannuation are populated in the governed Xero P&L. Deputy remains authoritative for worked hours and operational timesheet wage cost.", recordedAt: "2026-08-18T12:00:00Z" },
]);
